...
export class CardContext {
  ...
  get config() {
    return this._card.config;
  }
  get language() {
    return this._card.language;
  }
  get selectedPreset() {
    return this._card.selectedPreset;
  }
  get selectedProfile() {
    return this._card.selectedProfile;
  }
  get hasUnsavedChanges() {
    return this._card.hasUnsavedChanges;
  }
  get isMenuOpen() {
    return this._card.isMenuOpen;
  }
