...
export const I18N = {
  en: {
    ...
    descriptions: {
      ...
      step4:
        "Use this template to create an automation that applies your schedule.",
    ...
    fields: {
      ...
      target_entity_desc:
        "The entity where scheduled values will be applied (climate, number, or switch).",
      package_label: "Configuration Package",
      package_desc:
        "Copy this “Configuration Package” into {path}. If you continue in the wizard, CronoStar will try to create/update the file automatically (when supported by the backend).",
      enable_pause_label: "Enable switch",
      enable_pause_desc: "Add a switch to enable or disable the automation",
      enable_profiles_label: "Enable Current profile selector",
      enable_profiles_desc:
        "Add a profile selector to switch between different schedules",
      keyboard_modifiers_title: "Keyboard Movement Modifiers",
      keyboard_modifiers_desc:
        "Configure how points move when using keyboard arrow keys with modifiers.",
      ctrl_label: "Ctrl (Precision)",
      shift_label: "Shift (Snap)",
      alt_label: "Alt (Fast)",
      def_label: "Default (No Modifier)",
    ...
    prompts: {
      reset_confirm:
        "Are you sure you want to reset this card? All current settings will be lost.",
    },
    notify: {
    ...
    ui: {
      ...
      prefix_hint:
        "Must be lowercase letters/numbers/underscores and end with underscore (_).",
  ...
  it: {
    ...
    descriptions: {
      step0:
        "Scegli un'azione: configurare un nuovo preset o analizzare i profili esistenti.",
      step1:
        "Configura gli elementi essenziali: entità di destinazione e prefisso identificativo.",
      ...
      step4:
        "Usa questo template per creare l'automazione che applica il programma.",
    ...
    fields: {
      ...
      target_entity_desc:
        "L'entità da controllare con questa programmazione (es. climate.salotto).",
      ...
      def_label: "Default (Nessun tasto)",
    ...
    prompts: {
      reset_confirm:
        "Sei sicuro di voler resettare questa card? Tutte le impostazioni correnti andranno perse.",
    },
    notify: {
    ...
    ui: {
      ...
      prefix_description_simple:
        "Usato per identificare tutte le entità CronoStar.",
...
export class EditorI18n {
  ...
  _t(path, replacements = {}) {
    ...
    if (obj === undefined) {
      log(
        "warn",
        this.editor?._config?.logging,
        `[EditorI18n] Missing translation: ${path}`,
      );
      return path;
    }
