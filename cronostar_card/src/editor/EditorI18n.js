...
export const I18N = {
  en: {
    ...
    ui: {
      ...
      no_matching_entities: 'No compatible entities found for the selected preset. Required types: {domains}',
  ...
  it: {
    ...
    ui: {
      ...
      no_matching_entities: 'Nessuna entità compatibile trovata per il preset selezionato. Tipi richiesti: {domains}',
