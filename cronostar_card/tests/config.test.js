...
describe("VERSION", () => {
  ...
  it('falls back to "6.8.8" if window.CRONOSTAR_CARD_VERSION is not defined', () => {
    // window.CRONOSTAR_CARD_VERSION is undefined in jsdom → "6.8.8"
    expect(VERSION).toBe("6.8.8");
  });
});
